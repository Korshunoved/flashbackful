                    ...
                    <div style="cursor:pointer" onclick="window.location.href='/circle/?id=<?= $user->ID ?>'"
                        ...
                        <div class="img pop">
                            ...
                            if (!empty($uro)) {
                                ...
                                ?>
			<svg width="86" height="86" aria-hidden="true" class="svg-smile">
...
elseif ( in_array( 'influencer', $user_roles, true ) ) 
{
										...
										{
										$tik= get_user_meta($current_user->ID, 'buytik', true);	
										$spis=explode(';',$tik);
if (in_array($pd5, $spis)) 
{
?>
<div class="btns_buy">
<a href="javascript:void()" onclick="buy('<?=$pd5?>')" class="btn btn_green">BUY NFT</a>
<a href="#" class="modal__trigger btn-modal"  data-toggle="modal" data-target="modal-<?= $m; ?>"></a>
</div>
<?
}
else
...
else 
{
                                        ...
                                        <div class="btns_buy">
                                            <a href="#" class="btn btn_green btn-modal" data-toggle="modal" data-target="#modal_transf-<?= $m; ?>">Transfer</a>
                                            <a href="#" class="btn btn_green btn-modal" data-toggle="modal" data-target="#modal_burn-<?= $m; ?>">Burn</a>
                                        </div>
...
?>
                                ...
                                <div class="modal modal-share" id="modal-<?= $m; ?>">
								  <div class="modal__inner">
                                    <div class="modal_content">
                                        <!-- <a href="#" class="modal__close" data-toggle="modal" data-target="#modal-<?= $m; ?>"></a> -->
                                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                          <span aria-hidden="true"><img src="<?= get_template_directory_uri() ?>/img/svg/close2.svg" alt="mydance"></span>
                                        </button>
                                ...
                                <div class="modal modal-share" id="modal_transf-<?= $m; ?>">
                                  <div class="modal__inner">
                                    <div class="modal_content">
                                        <a href="#" class="modal__close" data-toggle="modal" data-target="#modal_transf-<?= $m; ?>"></a>
                                ...
                                <div class="modal modal-share" id="modal_burn-<?= $m; ?>">
                                  <div class="modal__inner">
                                    <div class="modal_content">
                                        <a href="#" class="modal__close" data-toggle="modal" data-target="#modal_burn-<?= $m; ?>"></a>
