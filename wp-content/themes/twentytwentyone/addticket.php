...
//////////////////////////
$string='{"avalanche":
{"version": 1,"type": "generic","title":"'.$nama.'","img": "'.$image_url.'","desc": "'.$desa.'"}}';
   $apiUrl = 'http://18.116.131.159:3000/encode';
    $message = $string;
    ...
    curl_setopt($ch2, CURLOPT_POSTFIELDS, $message);
...
?>
	<meta http-equiv="refresh" content="1;URL=/addevent/?id=<?=$_POST['idtov']?>" />
	<?
      ...
      <article class="content col">
        <ul class="content-public-event-top">
          ...
          <li>
            ...
            <div class="inner-flash inner-flash-num">
