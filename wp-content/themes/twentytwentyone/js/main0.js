...
"use strict";!function(e,n){var t,i,o;if("localhost"!==location.hostname&&"127.0.0.1"!==location.hostname&&""!==location.host){if(!n.createElementNS||!n.createElementNS("http://www.w3.org/2000/svg","svg").createSVGRect)return;var s,a="localStorage"in e&&null!==e.localStorage,r=function(){n.body.insertAdjacentHTML("afterbegin",s)};["http://cryptotik.beget.tech/verstka/img/symbol_sprite.html"].forEach(function(e){try{var t=new XMLHttpRequest;t.open("GET",e,!0),t.onload=function(){200<=t.status&&t.status<400&&(s=t.responseText,n.body?r():n.addEventListener("DOMContentLoaded",r),a&&(localStorage.setItem("inlineSVGdata",s),localStorage.setItem("inlineSVGrev",9),console.log("insert forEach isLocalStorage")))},t.send()}catch(e){}})}else t="/img/symbol_sprite.html",i=n.querySelector("body"),(o=new XMLHttpRequest).onload=function(){4==this.readyState&&200==this.status&&i.insertAdjacentHTML("afterbegin",o.responseText)},o.open("GET",t,!0),o.send(null);e=n.querySelectorAll(".inputfile");Array.prototype.forEach.call(e,function(e){var n=e.nextElementSibling,i=n.innerHTML;e.addEventListener("change",function(e){var t="";(t=this.files&&1<this.files.length?(this.getAttribute("data-multiple-caption")||"").replace("{count}",this.files.length):e.target.value.split("\\").pop())?n.querySelector("span").innerHTML=t:n.innerHTML=i}),e.addEventListener("focus",function(){e.classList.add("has-focus")}),e.addEventListener("blur",function(){e.classList.remove("has-focus")})})}(window,document),jQuery(function(i){i(".datepicker").datepicker({dateFormat:"dd-mm-yy"}),i(document).on("click",".slct",function(e){var n=i(this).parent().find(".drop");return n.is(":hidden")?(n.slideDown(150),i(this).addClass("active"),i(".drop").find("li").click(function(){var e=i(this).html(),t=i(this).attr("value");i(this).parent().parent().find("input").val(t).trigger("change"),i(this).parent().parent(".select").find(".slct").removeClass("active").html(e),n.slideUp(150)})):(i(this).removeClass("active"),n.slideUp()),!1});var e=document.querySelectorAll(".password-checkbox");e&&e.forEach(function(e){e.addEventListener("click",function(e){this.classList.toggle("active");var t=this.closest(".password-js").querySelector("input");this.classList.contains("active")?t.setAttribute("type","text"):t.setAttribute("type","password")})}),i(".owl-carousel-slider-3").owlCarousel({margin:17,nav:!0,dots:!1,items:3,responsive:{0:{items:1,nav:!1},500:{margin:10,items:2,nav:!1},1e3:{margin:10,items:2,nav:!1},1240:{items:2.5,margin:15},1600:{items:3,margin:17}}}),i(".owl-carousel-slider-4").owlCarousel({margin:17,nav:!0,dots:!1,items:4,responsive:{0:{items:2,nav:!1},500:{margin:10,items:2,nav:!1},1e3:{margin:10,items:3,nav:!1},1240:{items:4,margin:17}}}),i(".owl-carousel-slider-5").owlCarousel({margin:17,nav:!0,dots:!1,items:5,responsive:{0:{items:2,nav:!1},500:{margin:10,items:2,nav:!1},768:{margin:10,items:3,nav:!1},1e3:{margin:10,items:4,nav:!1},1240:{items:5,margin:17}}})}),document.addEventListener("DOMContentLoaded",function(){var e,t,n,i;document.querySelector("body");function o(){e.classList.toggle("active"),t.classList.toggle("block"),n.classList.toggle("active")}e=document.querySelector(".header__burger"),t=document.querySelector(".darken"),n=document.getElementById("menuModal"),i=0,e.onclick=function(e){console.log("burger.onclick e",e),o()},n.ontouchstart=function(e){console.log("modal.ontouchstart e",e),i=e.touches[0].clientX},n.ontouchend=function(e){console.log("modal.ontouchend e",e),i>e.changedTouches[0].clientX+60&&o()},window.addEventListener("click",function(e){console.log("window.addEventListener e",e),e.target===t&&o()})});