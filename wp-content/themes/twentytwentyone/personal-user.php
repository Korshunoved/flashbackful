...
if (!empty( $_POST['pay']))
{
update_user_meta( $idi, 'paypal', $_POST['pay'] );	
}
...
echo $fio=get_user_meta( $idd, 'fio', true);
		 ...
		 $nom=get_user_meta( $idd, 'idu', true);
		...
		<li class="nav-item">
            <a class="nav-link active" data-toggle="tab" href="#tab-sidebar-0" role="tab" aria-controls="tab-sidebar-1" aria-selected="false" >My Events</a></li>
          ...
          <li class="nav-item ">
            <a class="nav-link " data-toggle="tab" href="#tab-sidebar-3" role="tab" aria-controls="tab-sidebar-3" aria-selected="false" >FlashBs</a></li>
    ...
    <li class="nav-item nav-item-btn">
      ...
      <article class="content col content-tabs">
        <div class="tab-content" id="myTabContentSidebar">
          ...
          <div class="tab-pane fade show active" id="tab-sidebar-0" role="tabpanel">
	 ...
	 $tu=$er[0].'.'.$er[1];
          ...
          <div class="tab-pane fade" id="tab-sidebar-1" role="tabpanel">
           ...
           <div class="content-public-event">
              <div class="content-public-event d-flex">
		...
		?></div>
                ...
                <li>
                  ...
                  <div class="item">
				   ...
				   <div class="accept">
                      <div class="item">
                        <div class="h3">Accept fiat</div>
                        <a href="#" class="btn btn_green" data-toggle="modal" data-target="#modal__paypal">
                          <img src="/wp-content/themes/twentytwentyone/img/paypal.png" alt="">
                        </a>
                      </div>
                      <div class="item">
                        <div class="h3">Accept crypto</div>
                        <a href="#" class="btn btn_green" data-toggle="modal" data-target="#modal__wallet">Connect Wallet</a>
                      </div>
                    </div>
        ...
        <li class="item template">
            ...
            <span class="delete-link" style="display:none" title="Удалить">Удалить</span>
                ...
                <label for="input_logo">
                  ...
                  <span  id="ray2">Profile Picture <br><span class="size size-sm">200px X 200px</span></span> 
                </label>
        ...
        <li class="item template">
            ...
            <span class="delete-link1" style="display:none" title="Удалить">Удалить</span>
                ...
                <label for="input_bnner">
                  ...
                  <span style="font-size:14px;" id="ray1">Banner <br><span class="size size-sm">820px X 312px</span></span>
                </label>
		 ...
		 <div class="item">
          <button class="btn btn_pink" name="sub" value="sub" type="Submit" style="margin-top: 60px;font-weight: bold;">Submit</button>
        </div>
                </li>
              </ul>
            </div>
...
<div class="modal fade modal_pay" id="modal__wallet" tabindex="-1" role="dialog" aria-labelledby="modal__walletLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="h3 pink">Connect Wallet</div>
      <a href="#" class="btn btn_black" data-dismiss="modal"><img src="/wp-content/themes/twentytwentyone/img/metamax.png" alt=""></a>
      
    </div>
  </div>
</div>
<div class="modal fade modal_pay" id="modal__paypal" tabindex="-1" role="dialog" aria-labelledby="modal__paypalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="h3"><img src="/wp-content/themes/twentytwentyone/img/paypal-1.png" alt=""></div>
      <span class="pink">Please add your PayPal ID</span>
      <input name="pay" type="text" placeholder="PayPal ID">
      <button class="btn btn_pink" onclick="$('.modal_pay').click()" type="button">Submit</button>
	 ...
	 $tu=$er[0].'.'.$er[1];
		  ...
		  ?>
              <li >
				...
				<div class="events-list-btn flex">
